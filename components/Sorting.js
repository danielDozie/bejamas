...
export const Sorting = ({setShowMobileFilter, setLoading, setProducts}) => {

    const sort = useEffect(() => {
        const data = async () => {
            setLoading('Loading...');
            const res = await axios.get('https://mbejamas.hasura.app/api/rest/price_sorting');
                    ...
                    <div className="hidden md:inline-flex font-semibold text-xl text-right">
                        <div className="flex">
                            ...
                            <div className="flex ml-3 mr-3 text-sm font-normal text-gray-500">
                                ...
                                <select className="form-control -mt-2 text-normal border " onChange={() => {sort}}>
                                    <option value="price"><span className="ml-3 mr-3 font-normal text-black">Price</span></option>
                                    <option value="alphabets"><span className="ml-3 mr-3 font-normal text-black">Alphabets</span></option>
                                </select>
                            </div>
                        </div>
                    </div>
